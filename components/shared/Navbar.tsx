        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          ...
          <ul className="hidden md:flex items-center gap-6">
            ...
            <li>
              <Link
                href="/tienda/carrito"
                className="relative text-gris-light hover:text-dorado transition-colors"
              ...
              >
                ...
                {totalItems > 0 && (
                  <span className="absolute -top-2 -right-2.5 bg-rojo text-white text-[10px] font-bold w-4 h-4 rounded-full flex items-center justify-center">
                    {totalItems}
                  </span>
                )}
              </Link>
          ...
          <div className="flex items-center gap-3 md:hidden">
            ...
            <button
              type="button"
              className="text-gris-light hover:text-dorado transition-colors"
        ...
        <div className="md:hidden fixed inset-0 top-16 z-50 bg-[#1a0a0d] overflow-y-auto">
          <div className="px-6 py-8">
            <ul className="flex flex-col">
                ...
                <li key={link.href} className="border-b border-dorado/20 last:border-b-0">
                  ...
                  >
                    ...
                    {link.href === "/tienda" && totalItems > 0 && (
                      <span className="ml-2 bg-rojo text-white text-xs font-bold px-2 py-0.5 rounded-full">
                        {totalItems}
                      </span>
                    )}
                  </Link>
              ...
              {totalItems > 0 && (
                <li className="border-b border-dorado/20">
                  <Link
                    href="/tienda/carrito"
                    className="block py-4 text-xl text-dorado font-medium hover:text-ambar transition-colors"
                    onClick={() => setMobileOpen(false)}
                  >
                    Ver carrito
                    <span className="ml-2 bg-rojo text-white text-xs font-bold px-2 py-0.5 rounded-full">
